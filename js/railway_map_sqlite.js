...
// xhr.open('GET', '../../files/ottawa_railways.sqlite', true);
// xhr.responseType = 'arraybuffer';

// xhr.onload = e => {
// 	const uInt8Array = new Uint8Array(xhr.response);
// 	const db = new SQL.Database(uInt8Array);
// 	const contents = db.exec("SELECT * FROM company");
// 	console.log("contents: " + contents);
// 	// contents is now [{columns:['col1','col2',...], values:[[first row], [second row], ...]}]
// };
// xhr.send();

// import { createDbWorker } from "/sql-js-httpvfs/node_modules/sql.js-httpvfs"
import { createDbWorker } from "sql.js-httpvfs"
// import { createDbWorker } from "sql.js-httpvfs/dist"
...
const workerUrl = new URL(
	"/sql-js-httpvfs/node_modules/sql.js-httpvfs/dist/sqlite.worker.js",
	import.meta.url,
);
const wasmUrl = new URL(
	"/sql-js-httpvfs/node_modules/sql.js-httpvfs/dist/sql-wasm.wasm",
	import.meta.url,
);
...
const config = {
	...
	config: {
		...
		url: "../../files/ottawa_railways.sqlite" // url to the database (relative or full)
	}
};
...
const result = await worker.db.exec(`select * from company`, [123]);
